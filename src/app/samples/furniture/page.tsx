...
export default function FurnitureSamplePage() {
  ...
  const handleSubmit = async (values: SampleFormValues) => {
    ...
    try {
      ...
      await saveSample(user.uid, values, 'Mueble');
      toast({
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6">
        <Card>
          <CardHeader>
            <CardTitle>Nueva Muestra de Mueble</CardTitle>
            <CardDescription>
              Complete el formulario para registrar una nueva muestra de mueble.
            </CardDescription>
          </CardHeader>
          <CardContent>
